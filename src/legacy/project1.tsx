        ...
        <section className="mb-8">
          ...
          <div className="bg-white border border-gray-300 rounded-2xl shadow-sm overflow-hidden">
              <div className="bg-gray-100 px-6 py-3 border-b border-gray-200">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  로그를 1차적으로 scheme으로 분류하고, 애플리케이션 동작과 사용행태를 복기해가면서 세부적으로 분류했습니다.
                </p>
              </div>
...
ORDER BY session_start;`}
                  >
                    <p className="text-gray-700 text-sm">
                      세션 구분 기준을 30분 미사용 시점으로 설정하다 보니, 실제로는 10시간이 하나의 세션으로 잡히는 문제가 발생했습니다. 또한 실제 사용 행태를 생각해보면, 10분 이상 연속으로 사용하지 않는 경우가 많을 것으로 생각했습니다. 따라서 그래프처럼 이벤트 로그간 시간delta를 조사해, 유의미하게 꺾이는 구간을 발견하여 세션 구분 값으로 사용했습니다.
                    </p>
                  </CodeToggle>
                </div>
              </div>
